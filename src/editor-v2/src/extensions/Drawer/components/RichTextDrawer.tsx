...
import { Button } from '@editor-v2/components/ui';
import { Dialog, DialogContent, DialogFooter, DialogTitle, DialogTrigger } from '@editor-v2/components/ui/dialog';
import ControlDrawer from '@editor-v2/extensions/Drawer/components/ControlDrawer/ControlDrawer';
import { dataURLtoFile } from '@editor-v2/utils/file';
import { shortId } from '@editor-v2/utils/shortId';
import { useButtonProps } from '@editor-v2/hooks/useButtonProps';
import { Drawer } from '@editor-v2/extensions/Drawer/Drawer';
