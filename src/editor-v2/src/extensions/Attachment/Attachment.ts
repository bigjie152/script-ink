...
import { getFileTypeIcon } from '@editor-v2/extensions/Attachment/components/NodeViewAttachment/FileIcon';
import { NodeViewAttachment } from '@editor-v2/extensions/Attachment/components/NodeViewAttachment/NodeViewAttachment';
import type { GeneralOptions } from '@editor-v2/types';
import { getDatasetAttribute } from '@editor-v2/utils/dom-dataset';
import { normalizeFileSize } from '@editor-v2/utils/file';
