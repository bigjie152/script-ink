...
import { FileIconString } from '@editor-v2/extensions/Attachment/components/NodeViewAttachment/FileIconString';
import { normalizeFileType } from '@editor-v2/utils/file';
