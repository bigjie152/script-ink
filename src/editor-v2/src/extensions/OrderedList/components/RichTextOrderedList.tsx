...
import { OrderedList } from '@editor-v2/extensions/OrderedList/OrderedList';
import { useToggleActive } from '@editor-v2/hooks/useActive';
import { useButtonProps } from '@editor-v2/hooks/useButtonProps';

export function RichTextOrderedList() {
  const buttonProps = useButtonProps(OrderedList.name);
