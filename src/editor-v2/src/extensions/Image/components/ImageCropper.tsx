...
import { IconComponent, useToast } from '@editor-v2/components';
import { Button } from '@editor-v2/components/ui/button';
import {
  Dialog,
  DialogContent,
  DialogFooter,
  DialogTitle,
  DialogTrigger,
} from '@editor-v2/components/ui/dialog';
import { Image as ExtensionImage } from '@editor-v2/extensions/Image';
import { useExtension } from '@editor-v2/hooks/useExtension';
import { useLocale } from '@editor-v2/locales';
import { dataURLtoFile, readImageAsBase64 } from '@editor-v2/utils/file';
