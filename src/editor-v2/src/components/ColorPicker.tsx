...
import { Button, Input, Popover, PopoverContent, PopoverTrigger, Separator } from '@editor-v2/components';
import { NoFill } from '@editor-v2/components/icons/NoFill';
import { COLORS_LIST as DEFAULT_COLORS_LIST } from '@editor-v2/constants';
import { useLocalStorage } from '@editor-v2/hooks/useLocalStorage';
...
function ColorPicker(props: ColorPickerProps) {
  ...
  const [recentColorsStore, setRecentColorsStore] = useLocalStorage<string[]>(highlight ? 'richtext-recent-highlight' : 'richtext-recent-colors', []);
...
function AddMoreColor({ setColor }: AddMoreColorProps) {
  ...
  return (
    <Popover onOpenChange={setOpenColorMore}
      open={openColorMore}
    >
      <PopoverTrigger asChild>
        <div
